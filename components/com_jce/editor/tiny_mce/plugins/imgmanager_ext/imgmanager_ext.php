...
class WFImgManager_ExtPlugin extends WFMediaManager
{
    ...
    public function getSettings($settings = array())
    {
        $settings = array(
            ...
            'thumbnail_width' => $this->getParam('thumbnail_width', 120),
            'thumbnail_height' => $this->getParam('thumbnail_height', 90),
            'thumbnail_quality' => $this->getParam('thumbnail_quality', 80),
            'can_edit_images' => 1,
        );
