 ...
 *
 * @author      shumisha
 * @copyright   Yannick Gaultier - 2007-2015
 * @package     sh404SEF
 ...
 *
 */
class  Sh404sefExtpluginCom_sample extends Sh404sefClassBaseextplugin
{
	protected $_extName = 'com_sample';
	...
	{
		$this->_sefPluginPath = JPATH_ROOT . '/plugins/sh404sefextplugins/sample/com_sample.php';
	}
