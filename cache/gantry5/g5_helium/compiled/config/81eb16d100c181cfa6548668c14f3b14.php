...
return [
    ...
    'timestamp' => 1554845216,
    'checksum' => '70a55c552e84ddce34f40359197c0d61',
    'files' => [
        'templates/g5_helium/custom/config/_error' => [
            ...
            'styles' => [
                'file' => 'templates/g5_helium/custom/config/_error/styles.yaml',
                'modified' => 1522850391
            ]
        ],
...
.blog .page-header h2 {
    ...
    font-size: 24px;
        ...
        'index' => [
            ...
            'particles' => [
                'spacer' => [
                    'spacer-spacer-7451' => 'Spacer',
                    'spacer-spacer-2183' => 'Spacer',
                    'spacer-spacer-4816' => 'Spacer'
                ],
                'logo' => [
        ...
        'layout' => [
            ...
            'layout' => [
                '/navigation/' => [
                    0 => [
                        0 => 'spacer-spacer-7451 25',
                        1 => 'logo-9608 15',
                        2 => 'date-1256 20',
                        3 => 'social-3171 20',
                        4 => 'spacer-spacer-2183 20'
                    ],
                    1 => [
                        0 => 'spacer-spacer-4816 24',
                        1 => 'menu-6409 76'
                    ]
                ],
                '/header/' => [
            ...
            'content' => [
                ...
                'custom-8642' => [
                    'title' => 'Custom HTML',
                    'attributes' => [
                        'html' => '<h2 class="g-title">Произошла ошибка!</h2>
<p>Страница, которую Вы искали была удалена или перемещена.
 </p>',
                        'filter' => '0'
                    ]
                ],
