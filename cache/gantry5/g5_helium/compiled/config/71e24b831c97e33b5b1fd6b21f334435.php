...
return [
    ...
    'timestamp' => 1554832777,
    'checksum' => '21bd9b93b4b5ce59b22744b81d9ef999',
    'files' => [
        'templates/g5_helium/custom/config/10' => [
            'index' => [
                'file' => 'templates/g5_helium/custom/config/10/index.yaml',
                'modified' => 1554756585
            ],
            'layout' => [
                'file' => 'templates/g5_helium/custom/config/10/layout.yaml',
                'modified' => 1554756585
            ],
            'page/assets' => [
                'file' => 'templates/g5_helium/custom/config/10/page/assets.yaml',
                'modified' => 1553792318
            ],
            'page/head' => [
                'file' => 'templates/g5_helium/custom/config/10/page/head.yaml',
                'modified' => 1553792318
            ],
            'styles' => [
                'file' => 'templates/g5_helium/custom/config/10/styles.yaml',
                'modified' => 1522593868
            ]
        ],
    ...
    'data' => [
        'particles' => [
            ...
            'copyright' => [
                ...
                'link' => '',
                'additional' => [
                    'text' => 'Создание и продвижение сайта<br />веб-студия <a href="https://supershop.od.ua" target="blank" class="white">SuperShop</a>'
                ],
                'css' => [
                    'class' => ''
                ]
            ...
            'logo' => [
                ...
                'link' => '1',
                'url' => '',
                'image' => 'gantry-media://AirbagUA_logo_top.png',
            ...
            'social' => [
                ...
                'items' => [
                    ...
                    2 => [
                        ...
                        'text' => '',
                        'link' => 'https://www.instagram.com/airbagua_service/',
                        'name' => 'Instagram'
                    ]
                ]
            ],
        ...
        'styles' => [
            ...
            'font' => [
                'family-default' => 'family=Didact+Gothic&subset=latin-ext,latin,cyrillic,cyrillic-ext',
                'family-title' => 'family=Cuprum&subset=latin-ext,latin,cyrillic'
            ],
            'footer' => [
                'background' => '#474747',
                'text-color' => '#ffffff'
            ...
            'header' => [
                'background' => '#242424',
                'background-image' => 'gantry-media://header/AirbagUA_logo.png',
            ...
            'testimonials' => [
                'background' => '#a8a7a7',
                'background-image' => 'gantry-media://testimonials/004.jpg',
        ...
        'page' => [
            ...
            'assets' => [
                'favicon' => 'gantry-media://AirbagUA_logo_top.png',
                'touchicon' => 'gantry-media://AirbagUA_logo_top.png',
                'css' => [
                    0 => [
                        'location' => '',
                        'inline' => '.slogan{font-size:36px;line-height:40px;}
a.white{color:white;}
section#g-navigation {background-position-y:bottom!important; background-position-x: center!important; background-image: url(/templates/g5_helium/custom/images/header/AirbagUA_logo.png)!important;
    background-size: cover!important;
    background-repeat: no-repeat!important;
}
.g-owlcarousel.has-color-overlay .owl-stage > .owl-item:nth-child(even) .g-owlcarousel-item-img:after, .g-owlcarousel.has-color-overlay .owl-stage > .owl-item:nth-child(odd) .g-owlcarousel-item-img:after {opacity: 0.2!important;}
.h350 h2.sppb-addon-title.sppb-feature-box-title {min-height: 70px;}
.page-header h2 {
    line-height: 1;
    min-height: 100px;
}',
        ...
        'index' => [
            'name' => '10',
            'timestamp' => 1554756585,
            'version' => 7,
            'preset' => [
                'image' => 'gantry-admin://images/layouts/default.png',
                'name' => 'home_-_particles',
                'timestamp' => 1522481244
            ],
            'positions' => [
                'search' => 'Module Position',
                'callback' => 'Заказать консультацию'
            ],
            'sections' => [
            ...
            'particles' => [
                'messages' => [
                    'system-messages-9312' => 'System Messages'
                ],
                'date' => [
                    'date-4940' => 'Date'
                ],
                'custom' => [
                    'custom-3384' => 'Custom HTML',
                    'custom-2496' => 'Custom HTML',
                    'custom-5807' => 'Intro',
                    'custom-2652' => 'Custom HTML',
                    'custom-8838' => 'Custom HTML'
                ],
                'social' => [
                    'social-3146' => 'Social'
                ],
                'logo' => [
                    'logo-8580' => 'Logo / Image',
                    'logo-2265' => 'Logo / Image',
                    'logo-3805' => 'Logo / Image'
                ],
                'position' => [
                    'position-position-9001' => 'Module Position',
                    'position-position-2749' => 'Заказать консультацию'
                ],
                'spacer' => [
                    'spacer-4293' => 'Spacer',
                    'spacer-2395' => 'Spacer'
                ...
                'owlcarousel' => [
                    'owlcarousel-1007' => 'Owl Carousel'
                ],
                'contentcubes' => [
                    'contentcubes-7850' => 'Content Cubes'
                ],
                'content' => [
                    'system-content-1605' => 'Page Content'
                ],
                'copyright' => [
                    'copyright-5840' => 'Copyright'
                ],
                'horizontalmenu' => [
                    'horizontalmenu-9708' => 'Horizontal Menu'
                ],
                'totop' => [
                    'totop-9210' => 'To Top'
                ],
                'mobile-menu' => [
                    'mobile-menu-4863' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
                'default' => [
                    'navigation' => 'navigation',
                    'system-messages-9312' => 'system-messages-7972',
                    'date-4940' => 'date-6625',
                    'custom-3384' => 'custom-9435',
                    'social-3146' => 'social-3171',
                    'logo-8580' => 'logo-9608',
                    'custom-2496' => 'custom-9307',
                    'position-position-9001' => 'position-position-7102',
                    'spacer-4293' => 'spacer-9274',
                    'menu-7734' => 'menu-3134',
                    'spacer-2395' => 'spacer-3896',
                    'footer' => 'footer',
                    'logo-3805' => 'logo-9571',
                    'copyright-5840' => 'copyright-1736',
                    'custom-8838' => 'custom-9674',
                    'horizontalmenu-9708' => 'horizontalmenu-9034',
                    'totop-9210' => 'totop-8670',
                    'offcanvas' => 'offcanvas',
                    'mobile-menu-4863' => 'mobile-menu-5697'
                ]
            ]
        ],
        'layout' => [
    ...
    <h2 class="g-title">ПОДУШКИ БЕЗОПАСНОСТИ SRS AIRBAG</h2>
    <p>Компания “AirBagUa” занимается ремонтом и профессиональным восстановлением 
систем безопасности легковых автомобилей. Все технологии по восстановлению подушек в руль, коленей и панелей были получены от наших партнеров из США. Мы не просто восстанавливаем внешний вид накладок, a меняем в них пиропатроны. Это значит, что после восстановления системы безопасности вашего автомобиля, включая перешивку блока управления SRS и диагностику системы, aвтомобиль будет готов к эксплуатации с полностью функциональной системой безопасности, как до аварии. Бывают сложности с торпедами (панелями) сложных форм. Но у нас есть индивидуальный подход к каждому клиенту.Мы восстанавливаем структуру, подбираем точный цвет, ставим клеймо SRS Airbag. Как правило, клиенты задают вопрос – "будет как завод?". Мы занимаемся восстановлением, а не изготовлением. Наша компания может гарантировать работоспособность используемых нами элементов на момент продажи.</p><p>
Внешний вид будет максимально схожий с вашими элементами. В качестве гарантии ваших денежный средств, мы готовы брать оплату за готовый результат после вашей проверки на почтовом отделении в любой транспортной компании Украины, которая предоставляет услугу обратного платежа. Зачастую это : Интайм, Новая Почта, Гюнсел.
Наша фирма осуществляет восстановление всех типов систем безопасностей легковых автомобилей.</p><p>
Основной задачей при восстановлении является максимальное приближение внешнего вида к оригиналу. Чтобы начать ремонт торпеды нашим мастерам понадобится аккуратно снять торпеду и произвести разборку. Чтобы текстура панели, цвет и форма остались те же и не утратили свой внешний вид, мы используем в работе только фирменные материалы зарубежных производителей.</p>
                    ...
                    'attributes' => [
                        ...
                        'items' => [
                            0 => [
                                ...
                                'imageposition' => 'left',
                                'label' => '170$ - 200$',
                                'title' => 'Ремонт торпеды без подушки безопасности',
                                'link' => '#',
                                'linktext' => 'Получить консультацию &rarr;',
                                'buttonclass' => '',
                                'buttontarget' => '_self',
                                'name' => 'Item 1'
                            ],
