...
.red {
	...
	<div class="span10">
		...
		<h2>Changelog v2.2.0</h2>
		<ul class="version-history">
            <li><span class="version-new">New</span> Grid Layout has been moved to the front along with field previews.</li>
            <li><span class="version-new">New</span> Can change field status through the right-click menu.</li>
            <li><span class="version-new">New</span> Date and Time Picker options: 'Allowed Dates' and 'Allowed Dates Regex'.</li>
            <li><span class="version-upgraded">Upg</span> When editing a field the published status can now be changed from within the window.</li>
            <li><span class="version-upgraded">Upg</span> Field previews can be toggled off from the Configuration area.</li>
            <li><span class="version-fixed">Fix</span> Radio and Checkbox Groups are now truncated in the backend to prevent overflowing.</li>
            <li><span class="version-fixed">Fix</span> Free Text fields are now limited to a 100px height in the backend to prevent overflowing.</li>
			<li><span class="version-fixed">Fix</span> Legacy layouts have been removed. <strong>If you were still using them, install the <a href="https://www.rsjoomla.com/support/documentation/rsform-pro/plugins-and-modules/plugin-legacy-layouts.html" target="_blank">Legacy Layouts Plugin</a></strong></li>
            <li><span class="version-fixed">Fix</span> Legacy ordering has been removed.</li>
            <li><span class="version-fixed">Fix</span> Date and Time Picker now correctly restricts the year selection.</li>
            <li><span class="version-fixed">Fix</span> Date and Time Picker now focuses on the closest available date when Min or Max Date are used and local time is outside those dates.</li>
		</ul>
