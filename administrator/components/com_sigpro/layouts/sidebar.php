    ...
    <div class="sigSideBarWrapper sigTransition">
        <div class="sigFloatLeft sigBoxSizing sideBarTextArea">
            <div class="sideBarHeader sigTextCenter">
                ...
                <?php endif; ?>
                <a href="https://www.joomlaworks.net/support/docs/simple-image-gallery-pro" target="_blank" title="<?php echo JText::_('COM_SIGPRO_DOCUMENTATION'); ?>" class="sig-icon-help-circled">
            ...
            <?php echo SigProHelper::copyrights(); ?>
        </div>
        <div class="sigFloatRight sigBoxSizing sidebarHandle">
            <a class="sideToggler sig-icon-menu" href="#"></a>
            <div class="sigProThumbnailsToolbar">
                <?php if($this->view == 'galleries' || $this->view == 'gallery'): ?>
                <a href="#landscape" class="sigProRatioButton sigViewLandscape sigHighlighted" title="<?php echo JText::_('COM_SIGPRO_LANDSCAPE'); ?>"></a>
                <a href="#portrait" class="sigProRatioButton sigViewPortrait" title="<?php echo JText::_('COM_SIGPRO_PORTRAIT'); ?>"></a>
                <?php else: ?>
