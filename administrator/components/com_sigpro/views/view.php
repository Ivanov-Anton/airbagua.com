...
class SigProView extends SigProViewBase
{
    public function __construct($config = array())
    {
        ...
        if ($document->getType() == 'html') {
            ...
            $document->addStyleSheet(JURI::root(true).'/media/jw_sigpro/assets/css/fonts.css?v=3.6.2');
            $document->addStyleSheet(JURI::root(true).'/media/jw_sigpro/assets/css/style.css?v=3.6.2');
            ...
            $document->addScript(JURI::root(true).'/media/jw_sigpro/assets/js/script.js?v=3.6.2');
            ...
            if ($view == 'gallery') {
                ...
                // Plupload
                $document->addScript(JURI::root(true).'/media/jw_sigpro/assets/vendors/moxiecode/plupload/plupload.full.min.js?v=3.6.2');
                $document->addScript(JURI::root(true).'/media/jw_sigpro/assets/vendors/moxiecode/plupload/jquery.plupload.queue/jquery.plupload.queue.js?v=3.6.2');
                ...
                if ($lang) {
                    $document->addScript(JURI::root(true).'/media/jw_sigpro/assets/vendors/moxiecode/plupload/i18n/'.$lang.'.js?v=3.6.2');
                }
            }
            if ($view == 'media') {
                // jQueryUI
                ...
                // elFinder
                $document->addStyleSheet(JURI::root(true).'/media/jw_sigpro/assets/vendors/studio-42/elfinder/css/elfinder.min.css?v=3.6.2');
                $document->addStyleSheet(JURI::root(true).'/media/jw_sigpro/assets/vendors/studio-42/elfinder/css/theme.css?v=3.6.2');
                $document->addScript(JURI::root(true).'/media/jw_sigpro/assets/vendors/studio-42/elfinder/js/elfinder.min.js?v=3.6.2');
                ...
                if ($lang) {
                    $document->addScript(JURI::root(true).'/media/jw_sigpro/assets/vendors/studio-42/elfinder/js/i18n/elfinder.'.$lang.'.js?v=3.6.2');
