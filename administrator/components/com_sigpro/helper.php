...
class SigProHelper
{
    ...
    public static function copyrights()
    {
        ...
        if ($document->getType() == 'html' && JRequest::getCmd('tmpl', 'index') == 'index') {
            echo '<div id="sigProAdminFooter"><a href="https://www.joomlaworks.net/simple-image-gallery-pro" target="_blank">Simple Image Gallery Pro '.SIGPRO_VERSION.'</a><br />Copyright &copy; 2006-'.date('Y').' <a href="https://www.joomlaworks.net/" target="_blank">JoomlaWorks Ltd.</a></div>';
        }
    }
