...
class JFormFieldExport extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $links = 'index.php?option=com_speedcache&amp;view=configs&amp;layout=export&amp;tmpl=component';
        $html = array();
        // The book select button
        $html[] = '<div class="button2-left">';
        $html[] = '  <div class="blank">';
        $html[] = '<a style="text-decoration:none;" 
class="btn button modal ju-btn ju-btn-export" 
title="Export configuration" 
href="'.$links.'" 
rel="{handler: \'iframe\', size: {x:450, y:250}}">Export</a>';
        $html[] = '  </div>';
        $html[] = '</div>';
