 ...
 */
class Jutranslation {
    private static $extension = 'com_speedcache';
    private static $extension_slug = 'speedcache';
    ...
    public static function getInput($inline=false){
        ...
        $languages = array();
        if (is_callable(array('JLanguageMultilang','getSiteLangs'))){
        ...
        } elseif (is_callable(array('JLanguageHelper','getInstalledLanguages'))) {
        ...
        $html .= '<p>You can refer to the <a href="https://www.joomunited.com/documentation/ju-translation-translate-wordpress-and-joomla-extensions" target="_blank">documentation page</a> on joomunited for more informations about extension translation</p>';
        ...
        foreach ($languages as $language) {
            ...
            $html .=    '<span class="latest_version"><img src="components/com_speedcache/assets/images/radio.svg" alt="loading"/></span><br/>';
