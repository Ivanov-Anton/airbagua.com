...
/**
 * Class speedcacheControllerJutranslation
 */
class speedcacheControllerJutranslation extends JControllerLegacy {

    private $extension = 'com_speedcache';
    private $extension_slug = 'speedcache';
    private $extension_name = 'Speedcache';
    ...
    public function saveStrings(){
        ...
        include_once(JPATH_ADMINISTRATOR . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_speedcache' . DIRECTORY_SEPARATOR . 'helpers' . DIRECTORY_SEPARATOR . 'jutranslation.php');
