...
jQuery(document).ready(function($){
    ...
    $.ajax({
        ...
        success : function(data){
            ...
            $('#jutranslations-languages tbody tr').each(function(){
                ...
                $.each(data.data,function(){
                    if(this.language === lang){
                        ...
                        var html;
                        switch (versionCompare(julanguages.versions[this.language], this.extension_version, julanguages.revisions[this.language], this.revision)) {
                            case 1:
                            ...
                            case 0:
                                ...
                                break;
                            case -1:
                                if (julanguages.versions[this.language]) {
                        ...
                        $('#jutranslations-languages tr[data-lang="'+ this.language + '"] td .latest_version').html(html);
                        ...
                        $('.jutranslation-install').unbind().bind('click',function(e){
                            ...
                            $.ajax({
                                ...
                                data : {
                                    ...
                                    translation : $(this).data("id")
                                },
                                success : function(result){
                                    result = JSON.parse(result);

                                    //Do not show language columns if it's en-GB
                                    var show_reference = true;
                                    if(result.datas.language==='en-GB'){
                ...
                var $line = $('#jutranslations-languages tr[data-lang="'+ lang + '"]');
                if(found===false){
    ...
    $('.jutranslation-edition').click(function(e){
        ...
        getStrings(language, function(datas){
    ...
    $('.jutranslation-share').click(function(e){
        ...
        if(typeof SqueezeBox !== 'undefined' ){
            ...
            SqueezeBox.open(jutranslation_base_url + 'action=jutranslation&task=jutranslation.showViewForm&language=' +  $(this).closest('tr').attr('data-lang'), {handler: 'iframe'});
        }else{
            //Open Wordpress lightbox
            tb_show('Share with Joomunited',jutranslation_base_url + 'action=jutranslation&task=jutranslation.showViewForm&language=' +  $(this).closest('tr').attr('data-lang') + '&TB_iframe=true');
        }
    });
    ...
    function getStrings(language, done_function) {
        var strings = {};
        $.ajax({
            type: 'POST',
