    ...
    <table class="table table-striped">
        ...
        <tr>
            <th width="20" class="center">
                <?php echo JHtml::_('grid.checkall', 'checkall-toggle', 'JGLOBAL_CHECK_ALL', 'joomla_sc.checkAll(this , `url_exclude`)'); ?>
            </th>
            <th class="title">
        ...
        <?php foreach ($this->cacheitems as $i => $item) :
            if ($item->type == 'exclude'):
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td class="center">
                        <?php echo JHtml::_('grid.id', $i, $item->id, false, 'cid', 'url_exclude'); ?>
                    </td>
                    <td>
                    ...
                    <td class="center">
                        <?php echo JHtml::_('speedcache.statusExcludeCacheGuest', $i, $item->excludeguest, $canChange, 3); ?>
                    </td>
                    <td class="center">
                        <?php echo JHtml::_('speedcache.statusExcludeCacheLogged', $i, $item->excludelogged, $canChange, 3); ?>
                    </td>
                </tr>
                <?php
            endif;
