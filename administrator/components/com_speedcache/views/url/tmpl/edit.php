...
<form action="<?php echo JRoute::_('index.php?option=com_speedcache&layout=edit&id=' . (int)$this->item->id); ?>"
    ...
    <fieldset class="adminform">
        ...
        <?php if ($this->item->type == 'include' || $this->item->type == 'rules_include' || $this->item->type == ''): ?>
            <?php if ($this->item->type === 'rules_include'): ?>
                <div class="control-group">
                    <div class="control-label">
            ...
            <?php if ($this->item->type != 'rules_include'): ?>
                <div class="control-group">
                    <div class="control-label">
                        <?php echo $this->form->getLabel('preloadguest'); ?>
                    </div>
                    <div class="controls">
                        <?php echo $this->form->getInput('preloadguest'); ?>
                    </div>
                </div>
            <?php endif; ?>
            <div class="control-group">
            ...
            <?php if ($this->item->type != 'rules_include'): ?>
                <div class="control-group">
                    <div class="control-label">
                        <?php echo $this->form->getLabel('preloadlogged'); ?>
                    </div>
                    <div class="controls">
                        <?php echo $this->form->getInput('preloadlogged'); ?>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                        <?php echo $this->form->getLabel('preloadperuser'); ?>
                    </div>
                    <div class="controls">
                        <?php echo $this->form->getInput('preloadperuser'); ?>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if ($this->item->type == 'exclude' || $this->item->type == 'rules_exclude') : ?>
            <div class="control-group">
                <div class="control-label">
                    <?php echo $this->form->getLabel('excludeguest'); ?>
                </div>
                <div class="controls">
                    <?php echo $this->form->getInput('excludeguest'); ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                    <?php echo $this->form->getLabel('excludelogged'); ?>
                </div>
                <div class="controls">
                    <?php echo $this->form->getInput('excludelogged'); ?>
                </div>
            </div>
        <?php endif; ?>
